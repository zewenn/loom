...
Work is continued on codeberg: https://codeberg.org/r4gus/uuid-zig. You can migrate by running:
```
zig fetch --save https://codeberg.org/r4gus/uuid-zig/archive/0.4.0.tar.gz
```
> Or just wait until the next release.
